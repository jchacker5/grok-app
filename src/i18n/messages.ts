...
const en = {
  ...
  "app.versionFooter": "Grok v0.1.13 · MIT · Unofficial · Sister project grok-go",
...
const zh: Record<MessageKey, string> = {
  ...
  "app.versionFooter": "Grok v0.1.13 · MIT · 非 xAI 官方 · 姐妹项目 grok-go",
  ...
  "composer.emoji": "表情符号",
  "composer.emojiSearch": "搜索表情符号",
  "composer.emojiEmpty": "没有匹配的表情符号",
  "emoji.category.smileys": "笑脸",
  "emoji.category.gestures": "手势",
  "emoji.category.people": "人物",
  "emoji.category.animals": "动物与自然",
  "emoji.category.food": "食物与饮品",
  "emoji.category.activities": "活动",
  "emoji.category.travel": "旅行与地点",
  "emoji.category.objects": "物品",
  "emoji.category.symbols": "符号",
  "mention.section.files": "文件",
  "mention.section.models": "模型",
  "mention.section.sessions": "会话",
  "mention.empty": "没有匹配的文件、模型或会话",
  "mention.filesLoading": "正在加载文件…",
  "composer.goal": "目标",
  ...
  "slash.memory": "记忆",
  "slash.memoryDesc": "打开全局、工作区与会话记忆",
  "slash.flush": "写入记忆",
  "slash.flushDesc": "将当前会话摘要保存到工作区记忆",
  "slash.dream": "整理记忆",
  "slash.dreamDesc": "在后台整合工作区记忆",
  "slash.newChat": "新会话",
  ...
  "memory.all": "全部",
  "memory.noWorkspaceFound": "此项目尚未找到工作区记忆。",
  "memory.noSessions": "未找到会话摘要。",
  "memory.selectWorkspace": "记忆工作区",
  "memory.selectSession": "选择一个会话摘要以查看内容。",
  "memory.clearGlobal": "清除全局记忆",
  "memory.clearWorkspace": "清除工作区记忆",
  "memory.clearAll": "清除全部记忆",
  "memory.clearTitle": "清除记忆",
  "memory.clearConfirm":
    "确定清除{scope}记忆吗？Grok Build 将通过其权威记忆索引操作移除数据。此操作无法撤销。",
  "memory.clearAction": "清除{scope}记忆",
  "memory.clearFailed": "无法清除记忆",
  "memory.save": "保存",
  "memory.saving": "正在保存…",
  "memory.saved": "已保存",
  "memory.unsaved": "有未保存的修改",
  "memory.revert": "还原",
