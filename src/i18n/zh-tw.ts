...
export const zhTW: Record<MessageKey, string> = {
  ...
  "composer.emoji": "表情符號",
  "composer.emojiSearch": "搜尋表情符號",
  "composer.emojiEmpty": "沒有符合的表情符號",
  "emoji.category.smileys": "笑臉",
  "emoji.category.gestures": "手勢",
  "emoji.category.people": "人物",
  "emoji.category.animals": "動物與自然",
  "emoji.category.food": "食物與飲品",
  "emoji.category.activities": "活動",
  "emoji.category.travel": "旅行與地點",
  "emoji.category.objects": "物品",
  "emoji.category.symbols": "符號",
  "mention.section.files": "檔案",
  "mention.section.models": "模型",
  "mention.section.sessions": "工作階段",
  "mention.empty": "沒有符合的檔案、模型或工作階段",
  "mention.filesLoading": "正在載入檔案…",
  "composer.goal": "目標",
  ...
  "settings.notifPrefs": "通知偏好設定",
  "settings.notifPrefsDesc": "按通道切換、靜默時段與事件通知觸發器",
  "settings.quietHours": "勿擾模式",
  "settings.quietHoursDesc": "在設定的靜默時段內屏蔽通知",
  "settings.github": "GitHub 整合",
  "settings.githubDesc": "將 GitHub Issue、PR 和提交連結到會話中；從對話建立 Issue",
  "settings.githubToken": "個人存取令牌 (PAT)",
  "settings.githubTokenPh": "ghp_xxxxxxxxxxxx",
  "settings.githubTestConn": "測試連線",
  "settings.sync": "多裝置同步",
  "settings.syncDesc": "透過共享資料夾跨裝置同步會話、設定、提示詞與指令",
  "settings.syncPath": "同步儲存路徑",
  "settings.syncMigrate": "遷移資料到同步資料夾",
  "ext.depGraph": "外掛相依性圖表",
  "ext.depGraphDesc": "已安裝外掛相依性的視覺化拓撲圖",
  "agentMemory.title": "代理記憶",
  "agentMemory.search": "搜尋記憶",
  "agentMemory.noMemories": "尚無記憶。代理在互動過程中會逐步建立記憶。",
  "agentMemory.clearAll": "清除全部",
  "agentMemory.clearConfirm": "確定清除所有記憶？此操作無法復原。",
  "agentMemory.refresh": "重新整理",
  ...
  "settings.exportSettingsDesc": "將所有應用程式設定儲存為 JSON 檔案，用於備份或搬移到其他裝置。",
  "settings.importSettings": "匯入設定…",
  "settings.importSettingsDesc": "從先前匯出的 JSON 檔案載入應用程式設定。",
  "settings.importSettingsSuccess": "設定已匯入。",
  "settings.importSettingsError": "匯入失敗：{error}",
  ...
  "slash.memory": "記憶",
  "slash.memoryDesc": "開啟全域、工作區與對話記憶",
  "slash.flush": "寫入記憶",
  "slash.flushDesc": "將目前對話摘要儲存至工作區記憶",
  "slash.dream": "整理記憶",
  "slash.dreamDesc": "在背景整合工作區記憶",
  "slash.newChat": "新對話",
  ...
  "memory.global": "全域",
  "memory.workspace": "工作區",
  "memory.sessions": "對話摘要",
  "memory.all": "全部",
  "memory.noWorkspaceFound": "此專案尚未找到工作區記憶。",
  "memory.noSessions": "找不到對話摘要。",
  "memory.selectWorkspace": "記憶工作區",
  "memory.selectSession": "選擇一則對話摘要以檢視內容。",
  "memory.clearGlobal": "清除全域記憶",
  "memory.clearWorkspace": "清除工作區記憶",
  "memory.clearAll": "清除全部記憶",
  "memory.clearTitle": "清除記憶",
  "memory.clearConfirm":
    "確定清除{scope}記憶嗎？Grok Build 將透過其權威記憶索引操作移除資料。此操作無法復原。",
  "memory.clearAction": "清除{scope}記憶",
  "memory.clearFailed": "無法清除記憶",
  "memory.save": "儲存",
  "memory.saving": "正在儲存…",
  "memory.saved": "已儲存",
  "memory.unsaved": "有未儲存的修改",
  "memory.revert": "還原",
  "memory.loading": "正在載入記憶…",
  "memory.loadFailed": "無法載入記憶",
  "memory.saveFailed": "無法儲存記憶",
...
"透過 `grok inspect` 發現的技能與 MCP 伺服器。開關控制對話注入與斜線技能過濾；有目前專案時以該目錄為 cwd。",  "ext.refresh": "重新整理",
  ...
  "session.bookmark": "收藏此會話…",
  "session.bookmarkNote": "收藏備註",
  "session.bookmarkNotePlaceholder": "備註…（選填）",
