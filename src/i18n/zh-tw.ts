...
export const zhTW: Record<MessageKey, string> = {
  ...
  "settings.notifySoundDesc": "桌面通知同時播放簡短提示音",
  "settings.notifyQuietHours": "免打擾",
  "settings.notifyQuietHoursDesc": "在每日指定時段內靜音桌面通知（本機時間）",
  "settings.notifyQuietHoursStart": "開始時間",
  "settings.notifyQuietHoursEnd": "結束時間",
  "settings.notifyOnCompletion": "回合完成時通知",
  "settings.notifyOnCompletionDesc": "工作階段就緒、可繼續輸入時提醒",
  "settings.notifyOnError": "發生錯誤時通知",
  "settings.notifyOnErrorDesc": "回合失敗時提醒",
  ...
  "account.col.when": "時間",
  "account.analytics.overview": "概覽",
  "account.analytics.perSession": "按對話",
  "account.analytics.totalSessions": "對話數",
  "account.analytics.totalTurns": "回合",
  "account.analytics.totalToolCalls": "工具呼叫",
  "account.analytics.totalTokens": "上下文 Token",
  "account.analytics.avgDuration": "平均時長",
  "account.analytics.modelBreakdown": "依模型",
  "account.analytics.dailyActivity": "近期活動",
  "account.analytics.topSessions": "最長對話",
  "account.analytics.selectSession": "對話",
  "account.analytics.sessionTurns": "回合",
  "account.analytics.sessionToolCalls": "工具呼叫",
  "account.analytics.sessionTokens": "上下文 Token",
  "account.analytics.sessionDuration": "時長",
  "account.analytics.sessionErrors": "錯誤數",
  "account.analytics.vsAverage": "對比平均值",
  "account.analytics.noData": "尚無對話，開始對話即可查看統計。",
  ...
  "exportImage.title": "匯出為圖片",
  "exportImage.selectMessages": "選擇要包含的訊息",
  "exportImage.selectAll": "全選",
  "exportImage.deselectAll": "取消全選",
  "exportImage.styleLight": "淺色",
  "exportImage.styleDark": "深色",
  "exportImage.includeMetadata": "包含標題與時間戳記",
  "exportImage.export": "匯出 PNG",
  "exportImage.exporting": "正在轉譯圖片…",
  "exportImage.exportSuccess": "圖片已儲存",
  "exportImage.exportFail": "圖片匯出失敗",
  "exportImage.noMessagesSelected": "請至少選擇一則訊息",
  "exportImage.tooMany": "最多選擇 {max} 則訊息",
  "exportImage.empty": "此對話尚無可匯出的訊息",
  "exportImage.messageCount": "已選 {count} 則",
  "exportImage.roleUser": "使用者",
  "exportImage.roleAssistant": "助理",
  "session.emptyRunToast":
    "本輪未呼叫任何工具就結束了。若任務未完成可回覆「繼續」；也可從對話選單匯出診斷包回報。",

  "sessionDiff.title": "比較對話",
  "sessionDiff.sessionA": "對話 A",
  "sessionDiff.sessionB": "對話 B",
  "sessionDiff.selectSession": "選擇一個對話…",
  "sessionDiff.selectTwoHint": "在上方選擇一個對話以比較訊息。",
  "sessionDiff.loading": "正在計算差異…",
  "sessionDiff.largeWarning": "其中一個或兩個對話訊息數超過 200 筆 — 計算差異可能需要一點時間。",
  "sessionDiff.computeAnyway": "仍然計算",
  "sessionDiff.messagesAdded": "新增 {n} 則",
  "sessionDiff.messagesRemoved": "刪除 {n} 則",
  "sessionDiff.messagesChanged": "變更 {n} 則",
  "sessionDiff.showUnchanged": "顯示未變更（{n}）",
  "sessionDiff.noDiff": "沒有可顯示的差異。",
  "sessionDiff.kindAdded": "新增",
  "sessionDiff.kindRemoved": "刪除",
  "sessionDiff.kindChanged": "變更",
  "sessionDiff.kindUnchanged": "未變更",
  "sessionDiff.roleUser": "使用者",
  ...
  "notify.turnErrorTitle": "回合失敗",
  "notify.turnErrorBody": "上一輪發生錯誤。",
  "notify.testTitle": "測試通知",
  ...
  "commands.title": "自訂命令",
  "commands.subtitle": "建立你自己的 /命令：插入文字、開啟面板或切換設定。",
  "commands.add": "新增命令",
  "commands.edit": "編輯",
  "commands.delete": "刪除",
  "commands.deleteConfirm": "刪除 /{name}？此操作無法復原。",
  "commands.empty": "尚無自訂命令。",
  "commands.emptyHint": "新增一個後即可在 / 選單中使用。",
  "commands.field.name": "名稱",
  "commands.field.namePh": "review",
  "commands.field.nameHint": "僅限字母、數字、底線——作為 /名稱 使用",
  "commands.field.description": "描述",
  "commands.field.descriptionPh": "插入程式碼審查提示詞",
  "commands.field.actionType": "動作",
  "commands.action.insertText": "插入文字",
  "commands.action.toggleSetting": "切換設定",
  "commands.action.openPanel": "開啟面板",
  "commands.field.insertText": "要插入的文字",
  "commands.field.insertTextPh": "請審查這段程式碼的錯誤與風格問題。",
  "commands.field.settingKey": "設定項",
  "commands.setting.wordWrap": "自動換行",
  "commands.setting.notificationsEnabled": "通知",
  "commands.setting.autoOpenTaskPanel": "自動開啟工作面板",
  "commands.setting.diffIgnoreWhitespace": "差異中忽略空白",
  "commands.field.panel": "面板",
  "commands.panel.automations": "自動化任務",
  "commands.panel.settings": "設定",
  "commands.panel.extensions": "擴充功能",
...
"透過 `grok inspect` 發現的技能與 MCP 伺服器。開關控制對話注入與斜線技能過濾；有目前專案時以該目錄為 cwd。",  "ext.refresh": "重新整理",
  ...
  "promptLibrary.trigger": "提示詞庫",
  "promptLibrary.title": "提示詞庫",
  "promptLibrary.searchPlaceholder": "搜尋提示詞…",
  "promptLibrary.applied": "已將「{name}」套用到輸入框",
  "promptLibrary.apply": "套用",
  "promptLibrary.saveCurrent": "將目前內容存為自訂",
  "promptLibrary.saveCustomTitle": "儲存自訂提示詞",
  "promptLibrary.editTitle": "編輯自訂提示詞",
  "promptLibrary.edit": "編輯",
  "promptLibrary.delete": "刪除",
  "promptLibrary.deleteConfirm": "刪除自訂提示詞「{name}」？",
  "promptLibrary.builtIn": "內建",
  "promptLibrary.loading": "載入中…",
  "promptLibrary.category.all": "全部",
  "promptLibrary.category.general": "通用",
  "promptLibrary.category.coding": "程式設計",
  "promptLibrary.category.writing": "寫作",
  "promptLibrary.category.analysis": "分析",
  "promptLibrary.category.custom": "自訂",
  "promptLibrary.noResults": "沒有符合的提示詞。",
  "promptLibrary.noCustom": "還沒有自訂提示詞，可在輸入框中儲存一個。",
  "promptLibrary.limitWarning": "已有 {n}+ 個自訂提示詞，建議整理一下。",
  "promptLibrary.field.name": "名稱",
  "promptLibrary.field.namePh": "例如：SQL 查詢助手",
  "promptLibrary.field.description": "描述",
  "promptLibrary.field.descriptionPh": "卡片上顯示的簡短說明",
  "promptLibrary.field.content": "提示詞內容",
  "promptLibrary.field.contentPh": "要傳送的指令…",
  "promptLibrary.field.category": "分類",

  "memory.title": "Agent 記憶",
  "memory.showPanel": "顯示 Agent 記憶",
  "memory.hidePanel": "隱藏 Agent 記憶",
  "memory.scopeGlobal": "全域",
  "memory.scopeProject": "專案",
  "memory.scopeSessions": "會話記錄",
  "memory.search": "搜尋記憶…",
  "memory.all": "全部",
  "memory.refresh": "重新整理",
  "memory.clear": "清除",
  "memory.clearConfirmTitle": "清除記憶？",
  "memory.clearConfirmGlobal": "這將重設全域 MEMORY.md 筆記。會話記錄與語意索引不受影響。",
  "memory.clearConfirmProject": "這將重設專案 MEMORY.md 筆記。會話記錄與語意索引不受影響。",
  "memory.notFound":
    "尚未找到記憶儲存。Grok Build 會在首次儲存記憶時於 GROK_HOME 下建立。",
  "memory.empty": "尚無儲存的記憶。",
  "memory.emptyHint": "Agent 會在您使用過程中逐步建立記憶。",
  "memory.noMatch": "沒有符合的項目。",
  "memory.loading": "正在載入記憶…",
  "memory.loadError": "無法讀取",
  "memory.error": "無法讀取 Agent 記憶",
  "memory.updated": "更新於 {time}",
};
