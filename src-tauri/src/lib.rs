...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::custom_prompts_list,
            commands::custom_prompt_create,
            commands::custom_prompt_update,
            commands::custom_prompt_delete,
            commands::custom_commands_list,
            commands::custom_command_create,
            commands::custom_command_update,
            commands::custom_command_delete,
